...
class Monitor extends BeanModel {
    ...
    toJSON(preloadData = {}, includeSensitiveData = true) {
        ...
        if (includeSensitiveData) {
            data = {
                ...
                tlsKey: this.tlsKey,
                kafkaProducerSaslOptions: this.kafkaProducerSaslOptions ? JSON.parse(this.kafkaProducerSaslOptions) : {},
    ...
    async start(io) {
        ...
        const beat = async () => {
            ...
            // Calculate uptime
            let uptimeCalculator = await FoxticUptimeCalculator.getUptimeCalculator(this.id);
