...
class SetupDatabase {
     ...
     * @param  {FoxTicServer} server the main server instance
     */
    constructor(args, server) {
        ...
        if (process.env.FOXTIC_DB_TYPE || process.env.UPTIME_KUMA_DB_TYPE) {
            this.needSetup = false;
            log.info("setup-database", "Database type is provided by env, try to override db-config.json");
            dbConfig.type = process.env.FOXTIC_DB_TYPE || process.env.UPTIME_KUMA_DB_TYPE;
            dbConfig.hostname = process.env.FOXTIC_DB_HOSTNAME || process.env.UPTIME_KUMA_DB_HOSTNAME;
            dbConfig.port = process.env.FOXTIC_DB_PORT || process.env.UPTIME_KUMA_DB_PORT;
            dbConfig.dbName = process.env.FOXTIC_DB_NAME || process.env.UPTIME_KUMA_DB_NAME;
            dbConfig.username = process.env.FOXTIC_DB_USERNAME || process.env.UPTIME_KUMA_DB_USERNAME;
            dbConfig.password = process.env.FOXTIC_DB_PASSWORD || process.env.UPTIME_KUMA_DB_PASSWORD;
