 ...
 * @type {FoxTicBackendServer}
 */
class FoxTicBackendServer {
    /**
    ...
    /**
     * Main maintenance list - DISABLED
     * @type {{}}
     */
    // maintenanceList = {};
     ...
     * @returns {FoxTicBackendServer} Server instance
     */
    static getInstance() {
        if (FoxTicBackendServer.instance == null) {
            FoxTicBackendServer.instance = new FoxTicBackendServer();
        }
        return FoxTicBackendServer.instance;
    }
     ...
     */
    constructor() {
        // Set axios default user-agent to FoxTic/version
    ...
    /**
     * Send maintenance list to client - DISABLED 
    ...
    /**
     * Send list of maintenances to user - DISABLED
    ...
    /**
     * Get a list of maintenances for the given user - DISABLED
    ...
    /**
     * Load maintenance list and run - DISABLED
    ...
    /**
     * Retrieve a specific maintenance - DISABLED
     ...
     */
    getUserAgent() {
        return "FoxTic/" + require("../package.json").version;
    }
