...
class Database {
    ...
    static async patch(port = undefined, hostname = undefined) {
        // Still need to keep this for old versions of FoxTic
        ...
        try {
            ...
            if (e.message.includes("the following files are missing:")) {
                ...
                log.warn("db", "Database migration failed, you may be downgrading FoxTic.");
            } else {
     ...
     *
     * Normally, it should be in transaction, but FoxticUptimeCalculator wasn't designed to be in transaction before that.
     * I don't want to heavily modify the FoxticUptimeCalculator, so it is not in transaction.
    ...
    static async migrateAggregateTable(port, hostname = undefined) {
        ...
        for (let monitor of monitors) {
            ...
            for (let date of dates) {
                ...
                let calculator = new FoxticUptimeCalculator();
