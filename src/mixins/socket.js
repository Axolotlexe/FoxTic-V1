...
export default {
    ...
    methods: {
        ...
        /**
         * Get list of maintenances - DISABLED
         * @param {socketCB} callback Callback for socket response
         * @returns {void}
         */
        ...
        addMaintenance(maintenance, callback) {
            ...
            if (callback) {
                callback({
                    ok: false,
                    msg: "Maintenance functionality has been removed"
                });
            }
        },

        /**
         * Add monitors to maintenance - DISABLED
        ...
        /**
         * Add status page to maintenance - DISABLED
         * @param {number} maintenanceID Maintenance to modify
        ...
        /**
         * Get monitors affected by maintenance - DISABLED
        ...
        /**
         * Get status pages where maintenance is shown - DISABLED
         * @param {number} maintenanceID Maintenance to read
         * @param {socketCB} callback Callback for socket response
         * @returns {void}
         */
