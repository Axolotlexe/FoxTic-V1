    ...
    methods: {
        ...
        getChartDatapointsFromHeartbeatList() {
            ...
            for (const beat of heartbeatList) {
                ...
                switch (beat.status) {
                    case MAINTENANCE:
                        colorData.push("rgba(23, 71, 245, 0.41)"); // Bleu
                        break;
                    case PENDING:
                        colorData.push("rgba(245, 182, 23, 0.41)"); // Jaune
                        break;
                    case UP:
                        colorData.push("rgba(92, 221, 139, 0.41)"); // Vert
                        break;
                    default: // DOWN
                        colorData.push("rgba(220, 53, 69, 0.41)"); // Rouge
                }
