            ...
            <div class="functions">
                <div class="d-flex justify-content-between action-buttons">
                    ...
                    <div class="close-button">
                        <router-link to="/dashboard" class="btn btn-normal">
                            {{ $t("Close") }} <font-awesome-icon icon="arrow-right" />
                        </router-link>
                    </div>
                </div>
            </div>
            ...
            <div class="shadow-box">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <span class="badge " :class=" 'bg-' + status.color " style="font-size: 30px;" data-testid="monitor-status">{{ status.text }}</span>
                    </div>
                </div>
            </div>
